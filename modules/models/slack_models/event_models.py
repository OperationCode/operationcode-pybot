...
class MessageReceivedChannelEvent(BaseModel):
    team_id: str = Field(..., example="T024BE7LD", description="The Slack ID of the team")
    api_app_id: str = Field(
        ..., example="A02R6C6S9JN", description="The Slack application ID"
    )
    event: SlackMessageInfo = Field(..., description="The information about the message that was received")
    type: str = Field(
        ...,
        example="event_callback",
        description="The type of event, should always be event_callback",
    )
    event_id: str = Field(..., example="Ev02UJP6HDBR", description="The Slack provided ID of the event")
    event_time: int = Field(..., example=1642732981, description="The Unix timestamp of the event")
    event_context: str = Field(..., example="4-eyJldCI6Im1lc3NhZ2UiLCJ0aWQiOiJUMDFTQkxDUTU3QSIsImFpZCI6IkEwMlI2QzZTOUpOIiwiY2lkIjoiQzAxUlUxTUhNRkUifQ")
